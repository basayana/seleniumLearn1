...
class MyInfoPage(basePage):
    ...
    def update_myInfo(self, firstname, middlename, lastname):
        ...
        self.driver.find_element(*self._FIRST_NAME_TEXTBOX).clear()
        self.driver.find_element(*self._FIRST_NAME_TEXTBOX).send_keys(firstname)
        self.driver.find_element(*self._MIDDLE_NAME_TEXTBOX).clear()
        self.driver.find_element(*self._MIDDLE_NAME_TEXTBOX).send_keys(middlename)
        self.driver.find_element(*self._LAST_NAME_TEXTBOX).clear()
